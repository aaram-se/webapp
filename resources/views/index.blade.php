...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark pb_navbar pb_scrolled-light" id="pb-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html">Aaram</a>
        ...
        <div class="collapse navbar-collapse" id="probootstrap-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#section-why-us">Illustration</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-practicing-areas">Test Designer</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-attorneys">Documentation</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-testimonials">FAQ's</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-contact">Contact</a></li>
			<li class="nav-item"><a class="nav-link" href="#section-contribute">Contribute</a></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-end">
          <div class="col-md-6  order-md-1">
            ...
            <h2 class="heading mb-3">The Aaram Time</h2>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 pr-md-5 pr-sm-0">
            <h2 class="mt-0 heading-border-top mb-3 font-weight-normal">About Aaram</h2>
            <p>About Aaram</p>
          </div>
          <div class="col-lg-7">
            <div class="images">
          ...
          <div class="col-md">
            <div class="media pb_media_v2 d-block text-center mb-3">
              ...
              <div class="media-body">
                <h3 class="mt-0 pb_font-20">Group of Aaram</h3>
                <p>Initiative by people working at monotype</p>
              </div>
            </div>
          </div>
          <div class="col-md">
    ...
    <section class="pb_section" data-section="why-us" id="section-why-us">
      <div class="container">
        <div class="row justify-content-md-center text-center mb-5">
          <div class="col-lg-7">
            <h2 class="mt-0 heading-border-top font-weight-normal">Illustration</h2>
            <p>This is illustration</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-7">
              ...
              <div>
                <div class="d-lg-flex d-md-block slide_content">
                  ...
                  <div class="slide_content-text text-center">
                    ...
                    <h3 class="font-weight-normal mt-0 mb-4">Sample1</h3>
                   </div>
                </div>
              </div>
    ...
    <section class="pb_section pb_testimonial_v1" data-section="testimonials" id="section-testimonials">
      <div class="container">
        <div class="row justify-content-md-left text-left mb-5">
          <div class="col-lg-7">
		  <h2 class="mt-0 heading-border-top bold font-weight-normal text-blue text-underline">Frequently Asked Questions</h2>
		  </div>
		  <div class="container">
  <div class="row justify-content-md-center text-center mb-5">
  <div class="col-md-8">
